...
const PropertyCard = () => {
    const latestStatus = mockListing.statusLogs[mockListing.statusLogs.length - 1]?.newStatus || 'Unknown';
  
    const formattedDate = new Date(mockListing.createdAt).toLocaleDateString('en-GB', {
      day: '2-digit',
      month: 'short',
      year: 'numeric',
    });
    ...
    return (
        ...
        <div className="text-left">
          <p className="text-base text-gray-500">Property # {mockListing.id}</p>
        ...
        <h2 className="text-base font-semibold mb-4 text-left">
          {mockListing.street}, {mockListing.city}, {mockListing.state}, {mockListing.postcode}
        </h2>
